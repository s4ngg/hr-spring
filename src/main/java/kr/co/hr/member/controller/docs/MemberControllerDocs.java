...
public interface MemberControllerDocs {
    ...
    ResponseEntity<ApiResponse<Page<MemberResponseDTO>>> getAllMembers(
    ...
    ResponseEntity<ApiResponse<MemberResponseDTO>> createMember(@RequestBody MemberRequestDTO requestDTO);
    ...
    ResponseEntity<ApiResponse<MemberResponseDTO>> updateMember(@PathVariable Long memberId, @RequestBody MemberRequestDTO requestDTO);
    ...
    ResponseEntity<ApiResponse<Void>> deleteMember(@PathVariable Long memberId);
}