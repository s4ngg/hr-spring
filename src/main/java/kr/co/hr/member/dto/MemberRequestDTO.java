...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "직원 등록/수정 요청 DTO")
public class MemberRequestDTO {
    ...
    @Schema(description = "직원 이름", example = "홍길동", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
    ...
    @Schema(description = "비밀번호 (영문+숫자+특수문자 8~20자)", example = "password123!", requiredMode = Schema.RequiredMode.REQUIRED)
